...
- `redirect_uri` — the following host domains are allowed:
...
curl -G "https://agents.riskanalytics.dnb.com/authorize" \
  ...
  --data-urlencode "redirect_uri=https://global.consent.azure-apim.net/redirect/cre4a-5ftest-20oidc-20blank-20venkat-20mcp-202--4f5cffeb87292abb" \
...
```
https://global.consent.azure-apim.net/redirect/cre4a-5ftest-20oidc-20blank-20venkat-20mcp-202--4f5cffeb87292abb?code={authorization_code}&state={state}
```
...
curl -X POST "https://agents.riskanalytics.dnb.com/token" \
  ...
  --data-urlencode "redirect_uri=https://global.consent.azure-apim.net/redirect/app" \
